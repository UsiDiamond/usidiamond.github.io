...
const TECH_REGISTRY: Record<string, TechConfig> = {
  ...
  webgl:       { displayName: 'WebGL',           iconSlug: 'webgl',              iconColor: '990000', releaseUrl: 'https://registry.khronos.org/webgl/' },
  ...
  rxjs:        { displayName: 'RxJS',            iconSlug: 'reactivex',          iconColor: 'B7178C', releaseUrl: 'https://github.com/ReactiveX/rxjs/releases' },
  apachecamel: { displayName: 'Apache Camel',    iconSlug: null,                 iconColor: 'D13212', releaseUrl: 'https://camel.apache.org/releases/' },
  ibmzos:      { displayName: 'IBM z/OS',        iconSlug: 'ibm',                iconColor: '052FAD', releaseUrl: 'https://www.ibm.com/products/zos' },
  java:        { displayName: 'Java',            iconSlug: 'openjdk',            iconColor: '437291', releaseUrl: 'https://openjdk.org/projects/jdk/' },
  db2:         { displayName: 'IBM Db2',         iconSlug: 'ibm',                iconColor: '052FAD', releaseUrl: 'https://www.ibm.com/docs/en/db2' },
  websphere:   { displayName: 'WebSphere',       iconSlug: 'ibm',                iconColor: '052FAD', releaseUrl: 'https://www.ibm.com/support/pages/websphere-application-server-releases' },
  ...
  jabber:      { displayName: 'Cisco Jabber',    iconSlug: 'jabber',             iconColor: '1BA0D7', releaseUrl: 'https://www.cisco.com/c/en/us/support/unified-communications/jabber-windows/products-release-notes-list.html' },
  ...
  kofax:       { displayName: 'Kofax',           iconSlug: 'kofax',              iconColor: 'D90000', releaseUrl: 'https://community.kofax.com/s/question/0D53m00006FG8NUCA1/capture-release-announcements' },
  ...
  githubpages: { displayName: 'GitHub Pages',    iconSlug: 'github',             iconColor: 'FFFFFF', releaseUrl: 'https://github.blog/changelog/' },
};
